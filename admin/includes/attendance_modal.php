			...
			<div class="modal-body">
				<form class="form-horizontal" method="POST" action="attendance_add.php">
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" autocomplete="off" class="form-control" onKeypress="ValidarNumeros()" maxlength="8" id="employee" name="employee" required>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="date">
								<input type="text" class="form-control" onKeypress="ValidarNumeros()" autocomplete="off" id="datepicker_add" name="date" required>
							</div>
						</div>
					</div>
					<div class="form-group">
