          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="overtime_add.php">
          		  <div class="form-group">
                  	...
                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" onKeypress="ValidarNumeros()" id="employee" name="employee" required>
                  	</div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  	...
                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" onKeypress="ValidarNumeros()" id="hours" name="hours">
                  	</div>
                </div>
                <div class="form-group">
                  	...
                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" onKeypress="ValidarNumeros()" id="mins" name="mins">
                  	</div>
                </div>
                 <div class="form-group">
        ...
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9"> 
                      <div class="date">
                        <input type="text" class="form-control" onKeypress="ValidarNumeros()" id="datepicker_edit" name="date" required>
                      </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" onKeypress="ValidarNumeros()" id="hours_edit" name="hours">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" onKeypress="ValidarNumeros()" id="mins_edit" name="mins">
                    </div>
                </div>
                 <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" onKeypress="ValidarNumeros()" id="rate_edit" name="rate" required>
                    </div>
                </div>
          	</div>
          	<div class="modal-footer">
