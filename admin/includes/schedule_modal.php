            	...
            	<form class="form-horizontal" method="POST" action="schedule_add.php">
          		  <div class="form-group">
                      ...
                      <div class="bootstrap-timepicker">
                    	 <input type="text" class="form-control timepicker" onKeypress="ValidarNumeros()" id="time_in" name="time_in" required>
                      </div>
                  	</div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="bootstrap-timepicker">
                        <input type="text" class="form-control timepicker" onKeypress="ValidarNumeros()" id="time_out" name="time_out" required>
                      </div>
                    </div>
                </div>
          	</div>
        ...
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="bootstrap-timepicker">
                        <input type="text" class="form-control timepicker" onKeypress="ValidarNumeros()" id="edit_time_in" name="time_in">
                      </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="bootstrap-timepicker">
                        <input type="text" class="form-control timepicker" onKeypress="ValidarNumeros()" id="edit_time_out" name="time_out">
                      </div>
                    </div>
                </div>
          	</div>
