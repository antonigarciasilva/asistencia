          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="employee_add.php" enctype="multipart/form-data">
          		  <div class="form-group">
                  	...
                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" onkeypress="return soloLetras(event)"  id="firstname" name="firstname" required>
                  	</div>
                </div>
                <div class="form-group">
                  	...
                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" onkeypress="return soloLetras(event)"  id="lastname" name="lastname" required>
                  	</div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  	...
                  	<div class="col-sm-9"> 
                      <div class="date">
                        <input type="text" class="form-control" onKeypress="ValidarNumeros()" id="datepicker_add" name="birthdate">
                      </div>
                  	</div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" onkeypress="return soloLetras(event)"  id="contact" name="contact">
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" onkeypress="return soloLetras(event)"  id="edit_lastname" name="lastname">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9"> 
                      <div class="date">
                        <input type="text" class="form-control" onKeypress="ValidarNumeros()" id="datepicker_edit" name="birthdate">
                      </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" onkeypress="return soloLetras(event)"  id="edit_contact" name="contact">
                    </div>
                </div>
                <div class="form-group">
...
//keycode devuelve el código de caracteres que estan en el Unicode de la tecla que activa el OnKeypress evento  o Onkeydown y Onkeyup
//which devuelve el evento espedificado, que se pulsa la tecla del teclado o el botón del ratón.
//string representa datos textuales, tiene un valor de 16 bits, cada elemento de la cadena de caracteres ocupa un posición en la cadena.
//fromCharCode metodo estatico que devuelve una cadena creada mediante el uso de una secuencia de valores Unicode especificada 
